...
<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header"><img src="dist/img/cub_logo_intbg.png" style="width: 100%;margin-top:10px;"></li>
			<li class="active">
              <a href="Menu.do">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li>
                   <a href="#"><i class="fa fa-circle-o"></i><img src="dist/img/cardicons/rupay.jpg" alt="rupay"> E-COM POS <i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
                   ...
                   <!--    <a href="RupayInternationalTTUM.do?category=RUPAY"><i class="fa fa-angle-right"></i> Generate International TTUM </a> -->
					...
					<!-- <li>
                     ...
                     <li><a href="DownloadDhanaReports1.do?category=RUPAY"><i class="fa fa-angle-right"></i>Reports</a></li>
					<!-- <li>
                   ...
                   <!--   <li><a href="manualKnockoff.do?category=RUPAY"><i class="fa fa-angle-right"></i> Knockoff Records</a></li> -->
                     ...
                     <li>
                  <a href="#"><i class="fa fa-circle-o"></i><img src="dist/img/cardicons/rupay.jpg" alt="rupay"> ECOM - POS SETTLEMENT <i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
                     ...
                     <li><a href="RupaySettFileRollback.do?category=CASHNET"><i class="fa fa-angle-right"></i>Settlement File Rollback</a></li>
                     <li><a href="PresentmentFileUpload.do?category=RUPAY"><i class="fa fa-angle-right"></i>PresentMent File Upload</a></li>
                     <li><a href="CashAtPos.do?category=RUPAY"><i class="fa fa-angle-right"></i>Cash At POS</a></li>
				   </ul>
                   </li> 
				...
				<li>
                  <a href="#"><i class="fa fa-circle-o"></i><img src="dist/img/cardicons/nfs.jpg" alt="rupay"> ATM <i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
