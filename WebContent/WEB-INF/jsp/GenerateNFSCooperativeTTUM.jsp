...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Co-Operative Bank TTUM Generation
			<!-- <small>Version 2.0</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Co-Operative Bank TTUM Generation</li>
		</ol>
	</section>
			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="reportform"  action="DownloadCoopTTUM.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<div class="box-footer">
						<button type="button" class="btn btn-primary" onclick="processCoopTTUM();">Process</button>
