...
<script type="text/javascript" src="js/FisdomUpload.js"></script>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Fisdom File Upload</li>
		</ol>
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="uploadform"  action="AdjustmentFileUpload.do" method="POST"  commandName="fisdomFileUploadBean" enctype="multipart/form-data" >
					...
					<div class="box-footer" style="text-align: center">
						...
						<a onclick="processFisdomUpload();" class="btn btn-primary">Process</a>
					</div>
