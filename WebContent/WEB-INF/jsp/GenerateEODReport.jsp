...
<script type="text/javascript" src="js/EODReport.js"></script>
...
<form:form id="reportform"  action="DownloadEODReport.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<div class="box-footer" style="text-align: center">
						...
						<button type="button" class="btn btn-primary" onclick="downloadEOD();">Download</button>
