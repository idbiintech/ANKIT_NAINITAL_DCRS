...
<script type="text/javascript" src="js/NFSLateReversalTTUM.js"></script>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Late Reversal TTUM</li>
		</ol>
	</section>
			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="reportform"  action="DownloadReversalTTUM.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<div class="box-footer" style="text-align: center">
						...
						<a onclick="processReversalTTUM();" class="btn btn-primary">Process</a> 
						<a onclick="DownloadReversalTTUM();" class="btn btn-primary">Download</a>
