...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">TTUM Generation Rupay</li>
		</ol>
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<form:form id="processform" action="DownloadRupayUnmatchedTTUM.do"
						...
						<div class="box-body" id="subcat">
							...
							<div class="form-group" style="display:${display}">
								<label for="exampleInputEmail1" onchange="CallDollar()">Sub
									Category</label> <input type="text" id="category" value="${category}"
						 ...
						 --%>
							<div class="form-group" style="display:${display}">
								...
								<form:select class="form-control" path="typeOfTTUM"
									id="typeOfTTUM" onchange="getFields(this)">
									<option value="0">--Select --</option>
							...
							<div class="form-group" id="ttumDate" style="display: none">
								<label for="exampleInputPassword1">Tran Date</label> <input
						...
						<div class="box-footer" style="text-align: center">
							<a onclick="Process();" class="btn btn-primary">Process</a> <a
								onclick="Download();" class="btn btn-info">Download</a> <a
								onclick="RollbackTTUM();" class="btn btn-info">Rollback</a>
						</div>
