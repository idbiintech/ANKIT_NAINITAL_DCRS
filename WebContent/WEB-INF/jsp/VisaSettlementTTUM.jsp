...
<script type="text/javascript" src="js/VisaSettlementTTUM.js"></script>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Visa Settlement TTUM</li>
		</ol>
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="processform"  action="DownloadVisaSettlementTTUM.do" method="POST"  commandName="visaUploadBean" >
                   ...
                   <div class="box-body">
					...
					<div class="box-footer" style="text-align: center">
						<a onclick="TTUMProcess();" class="btn btn-primary">Process</a>
						<a onclick="DownloadTTUMReport();" class="btn btn-info">Download</a>
					</div>
