...
<script type="text/javascript" src="js/NFSSettlementTTUM.js"></script>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="reportform"  action="DownloadSettlementTTUM.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<div class="box-footer" style="text-align: center">
						...
						<a onclick="processSettlementTTUM();" class="btn btn-primary">Process</a>
