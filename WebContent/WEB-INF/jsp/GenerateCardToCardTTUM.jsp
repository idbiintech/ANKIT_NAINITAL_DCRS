...
<script type="text/javascript" src="js/CardToCardTTUM.js"></script>
...
<form:form id="processform"  action="DownloadCardToCardTTUM.do" method="POST"  commandName="unmatchedTTUMBean" >
