...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Rupay Presentment File Upload
			<!-- <small>Version 2.0</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Rupay Presentment File Upload</li>
		</ol>
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="presentmentform"  action="downloadReport.do" method="POST"  commandName="rupaySettlementBean" enctype="multipart/form-data" >
				...
				<div class="box-body">
					...
					<div class="box-footer" style="text-align: center">
						...
						<a onclick="reconProcess();" class="btn btn-primary">Process</a>						
						<a onclick="downloadReport();" class="btn btn-primary">Download</a>
					</div>
</form:form>
				</div>
				<!-- /.box -->
