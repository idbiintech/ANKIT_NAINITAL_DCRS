...
<script type="text/javascript" src="js/GenerateFisdomTTUM.js"></script>
...
<form:form id="processform"  action="DownloadFisdomTTUM.do" method="POST"  commandName="fisdomFileUploadBean" >
						...
						<div class="form-group" style="display:${display}">
							...
							<form:select class="form-control" path="typeOfTTUM" id="typeOfTTUM">
								<option value="0">--Select --</option>
									<option value="SUCCESS">SUCCESS TTUM</option>
									<option value="FAILURE">FAILED TTUM</option>	
							</form:select>
						</div>
