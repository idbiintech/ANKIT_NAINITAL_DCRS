...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Late Reversal</li>
		</ol>
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
					<form:form id="LateRevReport" action="downloadLateRevReport.do"
						...
						<div class="box-footer" style="text-align: center">
							<a onclick="processLateRev();" class="btn btn-primary">Process</a>
							<a onclick="downloadLateRev();" class="btn btn-primary">Download</a>
						</div>
					</form:form>
				</div>
				<!-- /.box -->
