...
<script type="text/javascript" src="js/NetworkFileUpdate.js"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form:form name="reportform" id="reportform" action="DownloadReports.do" method="POST" commandName="NetworkFileUpdateBean" >
                <form role="form">
                  ...
                  <div class="box-body">
                    <div class="form-group">
					  ...
					  <input type="text" id="stCategory" value="${category}" style="display: none">
					  <form:input path="category" id="category" name="category" value="${category}" style="display: none"/> 
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Date</label>
                      <form:input path="datepicker" readonly="readonly" id="datepicker"  placeholder="dd/mm/yyyy" class="form-control" autocomplete="off" />
