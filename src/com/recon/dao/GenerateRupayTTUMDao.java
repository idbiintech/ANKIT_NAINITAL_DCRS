...
public interface GenerateRupayTTUMDao {
	...
	public boolean IssurttumAlreadyGenrated(GenerateTTUMBean generatettumBeanObj) throws Exception;
	
	
	public boolean cleanAlreadyProcessedSURTTUMRecords(GenerateTTUMBean generatettumBeanObj)throws Exception;
