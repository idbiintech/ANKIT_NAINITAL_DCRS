...
public class GenerateRefundTTUMReports extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> map, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        HSSFSheet sheet = workbook.createSheet("Matched_Report");  
	...
	sheet = (HSSFSheet) workbook.createSheet("UnMatched_Report");
