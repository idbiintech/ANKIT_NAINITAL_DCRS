 ...
 * @author int6261
 */
public class Read_Switch_Rupay extends JdbcDaoSupport {
	...
	public boolean uploadSwitchData(CompareSetupBean setupBean,Connection con,MultipartFile file,FileSourceBean sourceBean) {
		...
		try {
	        ...
	        String newTargetFile = "ISG_01-May-2017.txt";//"SWT_29032017.txt";
	        String bnaId = "";
	       ...
	       // System.out.println("PROCESSING FILE " + seefilename);
	        ...
	        try {
	        	...
	        	fis = new FileInputStream("\\\\10.144.143.191\\led\\DCRS\\Raw_Files_01052017\\Switch_File_01052017\\" + newTargetFile);
	        	//fis = new FileInputStream("\\\\10.144.143.191\\led\\DCRS\\test\\"+file);
	        } catch (FileNotFoundException ex) {
	            Logger.getLogger(Read_Switch_Rupay.class.getName()).log(Level.SEVERE, null, ex);
	        }
	        ...
	        String insert = "INSERT INTO SWITCH_RUPAY_RAWDATA (MSGTYPE,PAN,TERMID,LOCAL_DATE,LOCAL_TIME,PCODE,TRACE,AMOUNT,ACCEPTORNAME,RESPCODE,TERMLOC,NEW_AMOUNT,TXNSRC,TXNDEST,REVCODE,AMOUNT_EQUIV,CH_AMOUNT,SETTLEMENT_DATE,ISS_CURRENCY_CODE,ACQ_CURRENCY_CODE,MERCHANT_TYPE,AUTHNUM,ACCTNUM,TRANS_ID,ACQUIRER,PAN2,ISSUER,REFNUM,CREATEDDATE,CREATEDBY,NEXT_TRAN_DATE,DCRS_TRAN_NO,PART_ID,FileDATE) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,sysdate,?,?,?,?,(to_date(?,'dd/mm/yyyy')))";
	...
	public static void main (String []args ){
		...
		Read_Switch_Rupay switchFile = new Read_Switch_Rupay();
